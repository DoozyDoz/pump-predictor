...
FUNDING_PERCENTILE = 10.0
FUNDING_CROSS_SECTIONAL_PCT = 15.0
FUNDING_HISTORY_DAYS = 90

OI_DIVERGENCE_LOOKBACK_DAYS = 7
OI_DIVERGENCE_HISTORY_DAYS = 30  # Binance OI history: ~1 month
OI_DIVERGENCE_PERCENTILE = 90  # top 10% of OI/price divergence
OI_DIVERGENCE_CROSS_SECTIONAL_PCT = 15.0
OI_PRICE_MAX_RISE_PCT = 5.0  # price must not have already pumped

LS_RATIO_HISTORY_DAYS = 30  # Binance LS ratio: ~30 days
LS_RATIO_PERCENTILE = 10.0  # bottom 10% = bearish sentiment
LS_RATIO_CROSS_SECTIONAL_PCT = 15.0

TAKER_RATIO_HISTORY_MS = 21 * 86400_000  # 21 days in ms
TAKER_RATIO_PERCENTILE = 10.0  # bottom 10% = seller dominance = potential squeeze
TAKER_RATIO_CROSS_SECTIONAL_PCT = 15.0
